...
T = [matrix(QQ, 9, 9, {(4,8):1, (5,7):-1, (7,5):-1, (8,4):1}),
...
reps = [[[matrix(QQ, 9, 9, {(0,3):1, (1,4):1, (2,5):1}),
        matrix(QQ, 9, 9, {(3,6):1, (4,7):1, (5,8):1}),
        matrix(QQ, 9, 9, {(0,1):1, (3,4):1, (6,7):1}),
        matrix(QQ, 9, 9, {(1,2):1, (4,5):1, (7,8):1})],
        [matrix(QQ, 9, 9, {(3,0):1, (4,1):1, (5,2):1}),
        matrix(QQ, 9, 9, {(6,3):1, (7,4):1, (8,5):1}),
        matrix(QQ, 9, 9, {(1,0):1, (4,3):1, (7,6):1}),
        matrix(QQ, 9, 9, {(2,1):1, (5,4):1, (8,7):1})],
        [matrix(QQ, 9, 9, {(0,0):1, (1,1):1, (2,2):1, (3,3):-1, (4,4):-1, (5,5):-1}),
        matrix(QQ, 9, 9, {(3,3):1, (4,4):1, (5,5):1, (6,6):-1, (7,7):-1, (8,8):-1}),
        matrix(QQ, 9, 9, {(0,0):1, (1,1):-1, (3,3):1, (4,4):-1, (6,6):1, (7,7):-1}),
        matrix(QQ, 9, 9, {(1,1):1, (2,2):-1, (4,4):1, (5,5):-1, (7,7):1, (8,8):-1})]],
...
C = matrix(QQ, [[2, -1, 0, 0], [-1, 2, 0, 0], [0, 0, 2, -1], [0, 0, -1, 2]])

res = border_apolarity_cycl_inv(T,reps,C,16)
